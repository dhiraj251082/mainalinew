...
class AppTheme {
  ...
  // The old themes using the deprecated backgroundColor property
  ...
  static ThemeData dark = ThemeData(
    ...
    ), colorScheme: ColorScheme.fromSwatch(primarySwatch: AppColor.primarySwatch).copyWith(surface: AppColor.backgroundBlack),
  );

  // The new themes using the colorScheme property
